...
\begin{abstract}
  This report documents the machine learning experiment for Group 008, following the CRISP-DM process model. GitHug repository with code and data is available at: \url{https://github.com/milialeksic/BI_ass3}
\end{abstract}
